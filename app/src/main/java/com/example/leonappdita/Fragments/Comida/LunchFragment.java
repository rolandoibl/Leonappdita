...
public class LunchFragment extends Fragment {
    RecyclerView rcvfragLunchProducto;
    ...
    private void ConsultarProductos() {
        ...
        Query consulta = mFirestore.collection("Comida/Productos/Comida");
    ...
    private void InicializarAdaptador() {
        ...
        rcvfragLunchProducto.setAdapter(adaptador);
    }
